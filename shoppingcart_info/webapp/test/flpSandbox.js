		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Home Shopping cart info",
									"targetURL": "#sync6cl1shoppingcartinfo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync6cl1shoppingcartinfo-display": {
								"semanticObject": "sync6cl1shoppingcartinfo",
								"action": "display",
								"description": "Home Shopping cart info",
								"title": "Home Shopping cart info",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync6.cl1.shoppingcartinfo",
									"url": sap.ui.require.toUrl("sync6/cl1/shoppingcartinfo")
								}
							}
						}
					}
