		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Scustom table ",
									"targetURL": "#sync6cl1customertable-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync6cl1customertable-display": {
								"semanticObject": "sync6cl1customertable",
								"action": "display",
								"description": "Scustom table ",
								"title": "Scustom table ",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync6.cl1.customertable",
									"url": sap.ui.require.toUrl("sync6/cl1/customertable")
								}
							}
						}
					}
