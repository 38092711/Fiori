		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "seats booking info chart",
									"targetURL": "#sync6cl1seatschart-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync6cl1seatschart-display": {
								"semanticObject": "sync6cl1seatschart",
								"action": "display",
								"description": "seats booking info chart",
								"title": "seats booking info chart",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync6.cl1.seatschart",
									"url": sap.ui.require.toUrl("sync6/cl1/seatschart")
								}
							}
						}
					}
