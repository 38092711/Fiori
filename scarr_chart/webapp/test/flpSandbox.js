		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Flight Chart",
									"targetURL": "#sync6cl1scarrchart-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync6cl1scarrchart-display": {
								"semanticObject": "sync6cl1scarrchart",
								"action": "display",
								"description": "Flight Chart",
								"title": "Flight Chart",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync6.cl1.scarrchart",
									"url": sap.ui.require.toUrl("sync6/cl1/scarrchart")
								}
							}
						}
					}
